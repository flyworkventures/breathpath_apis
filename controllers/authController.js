...
const signin = async (req, res, next) => {
  try {
    ...
    const userData = {
      ...
      favoritesExercises: parseJson(user.favorites_exercises, []),
      premiumDatas: parseJson(user.premium_datas, []),
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        favoritesExercises: parseJson(updatedUser.favorites_exercises, []),
        premiumDatas: parseJson(updatedUser.premium_datas, []),
