  ...
  try {
    ...
    const exercises = await db.query(
      `SELECT 
        ...
        title_ko, title_ja, title_es, title_it, title_hi, title_pt, title_ru, title_za,
        duration,
        benefits_tr, benefits_en, benefits_de, benefits_ar, benefits_fr,
        benefits_ko, benefits_ja, benefits_es, benefits_it, benefits_hi, benefits_pt, benefits_ru, benefits_za,
        explain_tr, explain_en, explain_de, explain_ar, explain_fr,
        explain_ko, explain_ja, explain_es, explain_it, explain_hi, explain_pt, explain_ru, explain_za,
        steps,
        is_premium,
        created_at,
        updated_at
    ...
    const transformedExercises = exercises.map(exercise => {
      ...
      return {
        ...
        title: {
          ...
          ch: exercise.title_za,
          za: exercise.title_za,
        },
        ...
        benefits: {
          ...
          ch: exercise.benefits_za ? JSON.parse(exercise.benefits_za) : [],
          za: exercise.benefits_za ? JSON.parse(exercise.benefits_za) : [],
        },
        explain: {
          ...
          ch: exercise.explain_za,
          za: exercise.explain_za,
        },
